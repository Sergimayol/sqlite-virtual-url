...
fn map_reqwest_error(err: reqwest::Error) -> sqlite_loadable::Error {
    sqlite_loadable::Error::from(err.to_string())
}
...
pub fn sqlite3_seriesrs_init(db: *mut sqlite3) -> Result<()> {
    ...
    let response = reqwest::blocking::get("https://littlebigcorp.org/api/hello")
