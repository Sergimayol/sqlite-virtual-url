...
CREATE VIRTUAL TABLE demo USING HTTPFS('https://raw.githubusercontent.com/plotly/datasets/refs/heads/master/2014_us_cities.csv', 'csv');
...
.timer off
CREATE VIRTUAL TABLE demo2 USING HTTPFS(url='https://raw.githubusercontent.com/plotly/datasets/refs/heads/master/2014_us_cities.csv', format='csv');
.timer on
